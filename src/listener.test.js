suite("listener", function () {
    ...
    var createInternalHttp;
    var createTunnelConnect;
    var createExternalServer;
    var ensureDir;

    var mockServer = function (name) {
        var servers = [];

        Servers[name] = function (options) {
            var server = {
                options: options,
    ...
    setup(function () {
        createInternalHttp   = Servers.createInternalHttp;
        createTunnelConnect  = Servers.createTunnelConnect;
        createExternalServer = Servers.createExternalServer;
        ensureDir            = FsEnv.ensureDir;
    });
